/*
    ...
    POST /app/admin/addroom                                            -> add a new room in the system
...
/*
    POST /app/admin/addroom -> add a new room in the system
*/
router.post('/app/admin/addroom', (req, res) => {
    ...
    if (_.isString(roomName) && !_.isNaN(roomName)) {
        ...
        room.save().then((room) => {
            ...
            res.status(200).redirect('/app/admin/adminrooms');
        }).catch((err) => {
            console.log(err);
            res.status(400).redirect('/app/admin/adminrooms');
        });
    } else {
        res.status(400).redirect('/app/admin/adminrooms', {messages: req.flash('success_msg', 'Room added succesfully.') });
    }
});
...
*/
router.post('/app/admin/deleterooms', (req, res) => {
